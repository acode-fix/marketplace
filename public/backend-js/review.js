...
if (token) {
    ...
    function updateReviewerMobileUser(reviewerData) {
        ...
        const img = photo_url
            ...
            : `<img  class="review-mobile-img"  src="${generateAvatar(
                  email
              )}" class="me-5" alt="">`;
        ...
        const dashboard = `
              ...
              <div class="ms-2">
                ...
                <h6 style="font-size:12px "class="mired-email">${
    ...
    function loadDashboardRating(avgRating, allReview, percentChange) {
       ...
       <h6 class="no-text">${total}</h6>
        ...
        const percetValue =
            validatPercent === 1 || validatPercent === 0
                ? `<div class="arrow-up ms-1  js-arrow"> <i class="fa-solid fa-arrow-up"></i><span>${
                      percentChange ?? 0
                  }%</span></div>`
                : `  <div class="arrow-up ms-1 mobile-text1 js-arrow "> <i class="fa-solid fa-arrow-down"></i><span>${
                      percentChange ?? 0
                  }%</span></div>`;
      ...
      <h6 class="fw-light ">Total Reviews</h6>
          <div class="mt-3" style="display: flex;align-items: center;">
            <h6 class="no-text js-total-review">${
                allReview ?? "No reviews"
            }</h6>
            ${percetValue}
          </div>
    ...
    function loadMobileDashboardRating(avgTotal, allReview, percentChange) {
        ...
        const percentValue =
            validatePercent === 1 || validatePercent === 0
                ? `<div class="arrow-up ms-1"><i class="fa-solid fa-arrow-up"></i><span>${
                      percentChange ?? 0
                  }%</span></div>`
                : `<div class="arrow-up ms-1 mobile-text1"><i class="fa-solid fa-arrow-down"></i><span>${
                      percentChange ?? 0
                  }%</span></div>`;
        ...
        const displayProgress = `<div class="progress-5">
              ...
              <div class="progress-1">
                <div class="" style="display: flex;">
                  ...
                  <div class="rate-layout">
                    <div style="height: 8px; width: 200px;" class="progress ms-2">
                      <div class="progress-bar  progress-bar-striped progress-bar-animated bg-dark" style="width: ${
    ...
    function loadReviewContent(products) {
        ...
        products.forEach((product) => {
            product.reviews.forEach((review) => {
                ...
                const img = reviewerPhoto
                    ...
                    : `<img  class="img-fluid js-profile" src="${generateAvatar(
                          reviewerEmail
                      )}" alt="" >`;
      ...
      <div class="row mt-4">
        ...
        <div class="col">
          <img width="60px"  src="/uploads/products/${getSingleImage(
              product.image_url
          )}" alt="">
        </div>
      </div>`;
    ...
    function loadMobileReviewContent(products) {
        ...
        <div class="structure-m">
          ...
          <div class="">
           ...
           ${stars}<span class="ps-2" style="font-size: small;">${
                    review.rate
                }</span>
          </div>
        ...
        <div class="mb-2">
         <img width="100px" src="/uploads/products/${getSingleImage(
             product.image_url
         )}" alt="">
        </div>
