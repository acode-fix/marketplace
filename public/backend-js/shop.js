    ...
    axios
        ...
        .then((response) => {
            ...
            if (response.status === 200 && response.data) {
                ...
                const verifyElementMobile =
                    document.querySelector(".become-tag-m");
                const textElements =
                    document.querySelectorAll(".js-hover-text");
  ...
  */
            ...
            function loadShopProducts(products) {
                ...
                if (products.length === 0) {
                    const shopVerifyEl =
                        document.querySelector(".shop-verify-div");
                    const shopVerifyMobileEl = document.querySelector(
                        ".shop-verify-div-mobile"
                    );

                    [shopVerifyEl, shopVerifyMobileEl].forEach(
                        (verifyElement) => {
                            if (verifyElement) {
                    ...
                    productList.innerHTML =
                        '<p class="text-danger">You have no product listed!!</p>';
          ...
          <div class="card card-preview">
              ...
              <div class="card-body">
                  ...
                  <div class="footer-card">
                      <p class="card-text infinix-text pt-3">${
                          product.title ?? "No title available"
                      }</p>
                      <button type="button" class="dropbtn2 top " data-dropdown-id="${
                          product.id
                      }">...</button>
      ...
      `;
            ...
            function shopSearch(searchParams) {
                axios
                    .get("/api/v1/search/shop/products", {
                        params: {
                            searchParams,
                        },
                    })
                    .then((response) => {
                        ...
                        if (response.status === 200 && response.data) {
                            ...
                            if (products.length === 0) {
                                const responseText =
                                    '<p class="text-danger fs-5">* Sorry, No match was found !! *</p>';
                                const productList =
            ...
            document.querySelectorAll(".next-to-step-2").forEach((nextStep) => {
                nextStep.addEventListener("click", () => {
                    document
                        .querySelectorAll(".modal-step-1")
                        .forEach((step1) => {
                            step1.style.display = "none";
                        });

                    document
                        .querySelectorAll(".modal-step-2")
                        .forEach((step2) => {
            ...
            document
                .querySelectorAll(".previous-to-step-1")
                .forEach((previousStep) => {
            ...
            const formModal = new bootstrap.Modal(
                document.getElementById("exampleModal-edit")
            );
            const formModalMobile = new bootstrap.Modal(
                    ...
                    .catch((error) => {
                        ...
                        if (error.response) {
                            if (
                                ...
                                const errorMsg =
                                    validationError(responseErrors);
            ...
            document
                ...
                .addEventListener("click", (event) => {
                    ...
                    const continueBtn =
                        document.querySelector(".update-loader");
            ...
            function loadDelBtn() {
                document.querySelectorAll(".js-delete").forEach((deleteBtn) => {
                    var modal = new bootstrap.Modal(
                        document.getElementById("exampleModal-2")
                    );
            ...
            products.forEach((product) => {
                ...
                const firstImageUrl =
                    imageUrls.length > 0 ? imageUrls[0] : "placeholder.jpg";
                ...
                mobileProduct += `
                    ...
                    <div class="sold-mobile">
                        <h6 class="amount-sold-m ps-1 pt-1">Sold ${
                            product.sold ?? 0
                        }</h6>
                        <img src="kaz/images/Rate.png" class="img-fluid ps-1" width="13px"
                            alt=""><span class="img-rate ps-1">${
                                product.avg_rating ?? 0
                            }</span>
                    </div>
            ...
            document
                .querySelectorAll(".js-mobile-card")
                .forEach((mobileCard) => {
                        ...
                        .then((response) => {
                            if (response.data && response.status === 200) {
                                ...
                                document.querySelector(".description").value =
                                    productData.description;
                                document.querySelector(".actual_price").value =
                                    productData.actual_price;
                                document.querySelector(".promo_price").value =
                                    productData.promo_price;
            ...
            document
                .getElementById("save-product-mobile")
                .addEventListener("click", () => {
                    const form1 = document.getElementById(
                        "edit-product-form-mobile1"
                    );
                    const form2 = document.getElementById(
                        "edit-product-form-mobile2"
                    );

                    const continueBtn =
                        document.querySelector(".mobile-loader");
                    const signupText = document.querySelector(".mobile-text");
                    const loader = document.querySelector(
                        ".mobile-loader-layout"
                    );
            ...
            document
                .querySelector(".js-cancel-mobile")
                .addEventListener("click", () => {
                    modal.hide();
                    //console.log(mobileProductId);
                });
            ...
            document
                .querySelector(".js-delist-mobile")
                .addEventListener("click", () => {
                    // console.log(mobileProductId);
