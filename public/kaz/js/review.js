...
document.addEventListener("DOMContentLoaded", function() {
  const connectElement = document.querySelector('.connect-shop4');
  
  // Add event listener for mouseover
  connectElement.addEventListener('mouseover', function() {
    connectElement.textContent = "Connect with me";
    connectElement.classList.add('with-padding4'); // Add class to reduce padding
  });
  
  // Add event listener for mouseout
  connectElement.addEventListener('mouseout', function() {
    connectElement.textContent = "Connect";
    connectElement.classList.remove('with-padding4'); // Remove class to revert padding
  });
});
