<x-admin-layouts>
                    ...
                    <ul class="pt-4 nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#home" role="tab"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="View all registered users">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#profile" role="tab"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="View all suspended users">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#messages" role="tab"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="View all deleted users">
                                <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                <span class="d-none d-sm-block">Deleted Users</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#user-without-shop-no" role="tab"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="View user without shop no">
                                <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-step-2" style="display: none;">
                        ...
                        <div style="float: right;">
                            <button type="button"
                                class="mt-5 btn btn-secondary previous-to-step-1 me-2">Previous</button>
    ...
    <div class="modal fade" id="suspendModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="unsuspendModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="align-items: flex-end;">
            <div class="modal-content">
                <div class="modal-header">
