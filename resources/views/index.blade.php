...
<body>
    ...
    <div id="index">
        ...
        <div class="navbar-1 fixed-top">
            <a class="js-logo-link" href=""><img class="buy_and_sell_logo js-logo-img"
            ...
            <div id="notification_icon_div"><img class="notification-icon"
                    src="{{ asset('innocent/assets/image/notification.svg') }}" alt="Logo" id="notification_icon">
            </div>
            <div id="notification_icon_div2"> <a href="{{ url('/notification_mobile') }}"><img
                        class="notification-icon js-auth" src="{{ asset('innocent/assets/image/notification.svg') }}"
                        alt="Logo"></a></div>

            <div><img id="profile_picture" src="" alt=".profile picture " class="mt-2 profile_picture js-default"></div>
        ...
        <div class="sidebar-container">
            ...
            <div class="main">
                ...
                <div id="shop_number_mobile_icon" class="shop_number_mobile_icon js-auth"
                    onclick="enter_shop_no_mobile()"><img src="{{ asset('innocent/assets/image/shop.svg') }}" alt="">
                </div>
                <div id="shop_number_mobile" class="shop_number_mobile">
                    ...
                    <input type="text" class="form-control js-mobile-input" id="shop_no_input_mobile"
                ...
                <div id="shop_no_dekstop2" class="shop3">
                    ...
                    <input type="text" class="form-control js-input-value" id="shop_no_input"
                        placeholder="enter shop no ">

                    <img class="js-send" src="{{ asset('innocent/assets/image/send 3.svg') }}" alt="" id="send"
                        onclick="return_enter_shop_no()">
                ...
                <div class="category_mobile">
                    ...
                    <a href="#" class="category-link js-auth" data-category-id="8"
                        data-category-name="Kitchen Utensils">
                        <div class="image2">
                    ...
                    <div class="others_mobile">
                        <a href="#" class="category-link js-auth" data-category-id="9" data-category-name="Others"
                            class="others_mobile_link">
                            <div>
                ...
                <div class="filter-result">
                    <p class="text-danger fs-6 ps-4">No Product listed in this region yet, will you like to list a
                        product</p>
                ...
                <div class="tell_us_what_u_want_input_area">
                    ...
                    <input type="text" name="details" class="tell_us_input js-tell-us-input"
                        placeholder="write the details of what you are searching for">
        ...
        <div class="footer_contanier">
            ...
            <div class="footer_icons">
                <a class="js-become" href="https://web.facebook.com/loopmart/"><img
                        src="{{ asset('innocent/assets/image/facebook.png') }}" alt=""></a>
                <img src="{{ asset('innocent/assets/image/twitter.png') }}" alt="">
                <img src="{{ asset('innocent/assets/image/linkedin.png') }}" alt="">
                <a class="js-become" href="mailto:info@gmail.com.ng"><img
                        src="{{ asset('innocent/assets/image/message.png') }}" alt=""></a>

            </div>
        </div>

        <!-- Modal -->
        <div class="modal fade" id="signup_login-modal" class="myModal" data-bs-backdrop="static"
                ...
                <div class="modal-content modal_content_signup_login">
                    ...
                    <div style="display: none" class="sign_up_modal">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="email" class="form-control input_field" id="signup_email"
                                placeholder="Email">
                        </div>
                        <div class="form-group">
                            <p class="showPasswordBtn"> <i class="fa-solid fa-eye"></i></p>
                            <label for="password" class="form-label"></label>
                            <input required type="password" class="form-control password_inputs input_field"
                        ...
                        <div class="auth_icons">
                            <div class="facebook_icon" style="cursor: pointer;">
                                <a href="" class="fb-login"> <img
                                        src="{{ asset('innocent/assets/image/Facebook Logo.png') }}" alt=""></a>
                            </div>
                            <div class="gmail_icon" style="cursor: pointer;">
                                <a href="" class="google-login"> <img
                                        src="{{ asset('innocent/assets/image/gmail.png') }}" alt=""></a>
                            </div>
                        </div>
                        <p>Already have an account? <a href="#" onclick="login()" class="signup_links">Login</a></p>
                        <button type="submit" class="signup_continue_button continueBtn-signup" onclick="signup()">
                        ...
                        <p>By signing up you accept <span><a class="signup_links" href="">Our Terms and
                                    Policy</a></span></p>
                    ...
                    <div id="loginModal" class="login_modal" style="display: block;">
                        ...
                        <div class="form-group">
                            <label for="email" class="form-label"></label>
                            <input required type="email" class="form-control input_field" id="login_email"
                                placeholder="Email">
                        </div>
                        <div class="form-group">
                            <p class="showPasswordBtn"> <i class="fa-solid fa-eye"></i></p>
                        ...
                        <p style="margin-top: 20px;">Don't have an account? <span><a href="#"
                                    onclick="showSignUpModal()" class="signup_links">Sign up</a></span></p>
                    ...
                    <div class="resetpassword" style="display: none;">
                        ...
                        <div class="reset_email">
                            <div class="form-group">
                                <label for="email" class="form-label"></label>
                                <input required type="email" class="form-control input_field" id="reset_email"
                                    placeholder="Email">
                    ...
                    <div class="chagepassword" id="changepassword" style="display: none;">
                        ...
                        <p class="type_new_password"> <span class="type_new_password_head">Hi, Welcome Back </span>
                            <br>
                        ...
                        <button
                            class="signup_continue_button change_password_button continueBtn continueBtn_error change-btn"
                        ...
                        <p>Already have an account? <span><a href="#" onclick="login3()"
                                    class="signup_links">Login</a></span></p>
        ...
        <div style="display: none;" class="modal fade" id="verifyOtpModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        <div class="reset_email">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control input_field" id="otp"
        ...
        <div class="notifications_region">
            ...
            <div class="d-flex ">
                ...
                <audio id="notificationSound">
                    <source src="{{ asset('innocent/assets/notification_sound/mixkit-bell-notification-933.wav') }}"
                        type="audio/mpeg">
                </audio>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollabled">
                <div class="modal-content modal_content">
                    ...
                    <div class="state_selection" id="stateSelection">
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Abakaliki')">Abakaliki
                        </p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Aba')">
                            Aba</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Abeokuta')">Abeokuta</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Abuja')">Abuja</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Ado Ekiti')">Ado Ekiti
                        </p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Akure')">Akure</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Asaba')">Asaba</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Awka')">
                            Awka</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Bauchi')">Bauchi</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Benin City')">Benin City
                        </p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Birnin Kebbi')">Birnin
                            Kebbi</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Calabar')">Calabar</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Damaturu')">Damaturu</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Delta')">Delta</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Dutse')">Dutse</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Edo')">
                            Edo</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Ekiti')">Ekiti</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Enugu')">Enugu</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Gombe')">Gombe</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Gusau')">Gusau</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Ibadan')">Ibadan</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Ikeja')">Ikeja</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Ilorin')">Ilorin</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Imo')">
                            Imo</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Jalingo')">Jalingo</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Jos')">
                            Jos</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Kaduna')">Kaduna</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Kano')">
                            Kano</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Katsina')">Katsina</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Lafia')">Lafia</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Lagos')">Lagos</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Lokoja')">Lokoja</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Maiduguri')">Maiduguri
                        </p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Makurdi')">Makurdi</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Minna')">Minna</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Ogun')">
                            Ogun</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Owerri')">Owerri</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Owere')">Owere</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Port Harcourt')">Port
                            Harcourt</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Sokoto')">Sokoto</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Umuahia')">Umuahia</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Uyo')">
                            Uyo</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Yenagoa')">Yenagoa</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close" onclick="changeLocation('Yola')">
                            Yola</p>
                        <p data-bs-dismiss="modal" class="location" aria-label="Close"
                            onclick="changeLocation('Zaria')">Zaria</p>
                    </div>
                </div>
            </div>
        </div>
