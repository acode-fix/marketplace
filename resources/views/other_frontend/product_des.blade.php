    ...
    <div class="body">
        ...
        <div>
            ...
            <div class="navbar-1 fixed-top">
                <img src="{{asset('innocent/assets/image/transparent_logo.png')}}" class="search_buy_and_sell_logo "
                    alt="" onclick="window.location.href='{{ url('/') }}';">
                ...
                {{-- <div><img id="profile_picture" src="" alt=".profile picture "
                        class="profile_picture js-product-desc-img"></div>
                <div><img id="profile_picture_mobile" src="" alt=".profile picture "
                        class="profile_picture_mobile js-product-desc-img"></div> --}}
            ...
            <div class="navbar-2 fixed-top">
                ...
                <div class="user_info">
                    {{-- <div><img src="innocent/assets/image/bike.png" alt=".profile picture " class="user_photo">
                    </div>
                ...
                <img src="{{asset('innocent/assets/image/transparent_logo.png')}}" alt=""
                    class="buy_and_sell_logo_product_des_mobile">
            ...
            <div class="sidebar_and_main_container">
                <div class="sidebar">
                                    ...
                                    <p class="location2">
                                        ...
                                        {{-- <span class="rate">
                                            <img style="margin-bottom: 4px"
                                                src="{{asset('innocent/assets/image/Rate.png')}}" alt="">
                                            <span class="rate_value">loading</span>
                                        </span> --}}
                                        {{-- <span><a class="js-review review-link ps-2 text-success"
                                                href="">Reviews</a></span> --}}
                                    </p>
                                </div>
                        ...
                        <div class="product_descriptoin_card">
                            ...
                            <div class="connect_buttons">
                                ...
                                {{-- <button class="product_card_veiw_shop_button">
                                    <a href="{{ url('/sellers-shop') }}">view shop <img
                                            src="innocent/assets/image/badge.png" alt=""></a>
                                </button> --}}
                                <button class="product_card_view_shop_button " id="viewShopButton"
                                    style="display: none;">
                                ...
                                <button class="product_card_connect_button js-connect-btn ">
                                    <a href="#">connect <img src="{{asset('innocent/assets/image/Shopping bag.png')}}"
                                            alt=""></a>
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Main Body Section -->
                    <!-- This part works for the mobile view -->
                    <div class="main2">
                                            ...
                                            <a href="#" class="product_card_link" data-product-id="1">
                                                <div class="card product_card">
                                                    ...
                                                    <div class="product_card_title">
                                                        ...
                                                        <img src="{{asset('innocent/assets/image/logo icon.png')}}"
                                                            alt="">
                        ...
                        <div class="tell_us_what_u_want_input_area">
                            <img src="{{asset('innocent/assets/image/dp.png')}}" alt=""
                                class="tell_us_what_u_want_profile js-img-tell">
                            ...
                            <button class="send js-send-mobile input-btn" onclick="send()">
                ...
                <div class="main" id="main">
                    ...
                    <div class="tell_us_what_u_want_input_area tell_us_what_u_want_input_area2">
                        <img src="{{asset('innocent/assets/image/dp.png')}}" alt=""
                            class="tell_us_what_u_want_profile tell_us_what_u_want_profile2 js-img-tell">
                        <div class="vertical_bar"></div>
                        <input type="text" name="details" class="tell_us_input tell_us_input2  js-input2"
                            placeholder="write the details of what you are searching for the details here">
                        <button class="send js-send-input input-btn2" onclick="send2()">
        ...
        notification codes -->
            ...
            <div class="notification_main" id="notification_main" onclick="show_notification2()">
                ...
                <div class="notifications_region">
                        ...
                        <div class="notification">
                            <div class="notification_details">
                                ...
                                <div class="message_area">
                                    <p class="message"><strong>congratulations </strong> <br>it is a perfect time to
                                        tell the
                                        world about it.</p>
                                    <p class="time">2 hours ago</p>

                                </div>
                                <img src="innocent/assets/image/laptop2.jpg" alt="Picture"
                    ...
                    <a href="#">
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/dp.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>suggested for you </strong> <br>enjoy 1000 points to
                                        boost your
                                        product to reach more audience.</p>
                                    <p class="time">5 hours ago</p>

                                </div>
                                <img src="innocent/assets/image/laptop.jpg" alt="Picture"
                                    class="notification_product_image">
                    ...
                    <a href="#">
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/bike.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>jane connected with you </strong> <br>tell us tell us
                                        your
                                        experience with the producttell us your experience with the product.your
                                        experience with
                                        the product.</p>
                        ...
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/bike.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>congratulations </strong> <br>tell us your experience
                                        with the
                                        product.</p>
                        ...
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/dp.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>james your experience matters </strong> <br>Your
                                        experience
                        ...
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/bike.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>congratulations </strong> <br>tell tell us your
                                        experience with
                        ...
                        <div class="notification">
                            <div class="notification_details">
                                <img src="innocent/assets/image/dp.png" alt="Profile Picture"
                                    class="notification_image">
                                <div class="message_area">
                                    <p class="message"><strong>congrats on your new listing </strong> <br>it is a
                                        perfect time
                    ...
                    <div class="d-flex ">
                        ...
                        <i id="volumeMuteIcon" class="fa-solid fa-volume-mute notification_volume"
                            style="display: none;" onclick="turnOffNotifications()"></i>
                        <audio id="notificationSound">
                            <source
                                src="{{asset('innocent/assets/notification_sound/mixkit-bell-notification-933.wav')}}"
                                type="audio/mpeg">
                        </audio>
            ...
            <div class="footer_contanier">
                ...
                <div class="footer_icons">
                    <a href="https://web.facebook.com/loopmart/"><img
                    ...
                    <a href="mailto:info@gmail.com.ng"><img src="{{asset('innocent/assets/image/message.png')}}"
                            alt=""></a>
            ...
            <!-- Modal -->
            <div class="modal fade" id="tell_us_what_u_want_input_condition" tabindex="-1"
