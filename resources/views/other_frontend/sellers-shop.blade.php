...
<body>
  ...
  <div class="header-section">
    ...
    <div class="left-section">
      <a href="{{ url('/') }}"><img class="ms-3 main-logo" src="{{asset('/kaz/images/transparent_logo.png')}}"
          alt=""></a>
    ...
    <div class="right-section me-4">
      <div class="create">
        <a href="{{ url('/ads') }}"><button type="button" class="btn btn-warning btn-height me-5"> + create
            Ads</button></a>
      </div>
      <div class="me-1">
  ...
  <div class="main">
        ...
        <div class="card-body ">
          ...
          {{-- <div class="ms-2">
            ...
            <div>
              ...
              <img src="{{ asset('') }}/kaz/images/star-active.svg" class="img-fluid image-rate" width="15px" alt="">
              <img src="{{ asset('') }}/kaz/images/star-active.svg" class="img-fluid image-rate" width="15px" alt="">
              <img src="{{ asset('') }}/kaz/images/star-nill.svg" class="img-fluid image-rate" width="15px" alt="">
                ...
                <div class="row">
                  <div class="col mt-2">
                    <div style="display: flex; align-items: center;">
                      ...
                      <div class="camera2">
                        <img class="badge-cam" height="20px" width="15px" src="{{ asset('') }}/kaz/images/badge.png"
                          alt="">
                      </div>
                      <div class="mt-4 ms-4">
                  ...
                  <div class="card-body">
                    <div class="card-structure">
                      ...
                      <div class="star-layout">
                        <div>
                          <img src="{{ asset('') }}/kaz/images/Rate.png" class="img-fluid image-rate" width="10px"
                            alt="">
                          <img src="{{ asset('') }}/kaz/images/Rate.png" class="img-fluid image-rate" width="10px"
                            alt="">
                          <img src="{{ asset('') }}/kaz/images/Rate.png" class="img-fluid image-rate" width="10px"
    ...
    <div style="margin-top: 109px" class="sellers-footer">
      ...
      <div>
        <a href="">
          <p class="fw-light  text-footer js-seller-help">Help <br>center</p>
        </a>
      </div>
      <div>
        <a href="/privacy">
  ...
  <div class="mobile-view">
    <div style="margin-top: -49px;" class="card  main-card-mobile">
      {{-- <img style="height:180px;" id="banner" src="{{ asset('') }}/kaz/images/thumbnail-2.webp"
        class="card-img-top main-img-border2" alt="...">
      <div class="card-body">
      ...
      <div style="margin-top: 10px;" class="row">
        <div class="col-5">
          <div class="card-body main-card-mobile-rm js-mobile-review-stars">
            ...
            <div class="pt-1 ">
              <a class="view-m js-mobile-verify-link" href=""><i>View all</i></a><span
                class="bracket ps-3 mobile-avg-rate"></span>
            </div>
              ...
              <div class="card card-preview" data-card-id="1">
                ...
                <div class="card-body">
                  ...
                  <div class="footer-card-mobile">
                    <div style="display: flex;align-items: center;">
                      <img style="margin-left:-10px;" width="8px" src="{{ asset('') }}/kaz/images/location.svg"
                        alt=""><span class="location-text ps-1">Lagos, Nigera</span>
                    </div>
