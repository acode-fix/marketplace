...
<body>
    ...
    <div class="body">
        ...
        <div class="navbar-1 fixed-top">
            ...
            {{-- <div id="notification_icon_div"><img src="{{asset('innocent/assets/image/notification.png')}}"
                    alt="Logo" id="notification_icon"></div> --}}
            <div id="notification_icon_div2"> <a href="{{ url('/notification_mobile') }}"><img
                        src="{{asset('innocent/assets/image/notification.png')}}" alt="Logo"></a></div>
        ...
        <div class="navbar-2 fixed-top">
            ...
            <img src="{{asset('innocent/assets/image/transparent_logo.png')}}" alt=".profile picture"
                class="search_buy_and_sell_logo ">
        </div>
                    ...
                    <div class="products_details_dekstop">
                        <div class="js-header">
                            ...
                            <div class="user_info2">
                                ...
                                <div class="close_product_des"><a href="{{ url('/') }}"><i
                                            class="fa-solid fa-close "></i></a></div>
                            </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                                ...
                                style="background-color: #ffce29;"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                                aria-label="Slide 2" style="background-color: #ffce29;"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"
                                aria-label="Slide 3" style="background-color: #ffce29;"></button>
                        </div>
                        ...
                        <div class="js-desc">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    366.5 cm <sup>2</sup> (-82.9% screen-to-body ratio) Resolution 1668 * 2388 pixels
                                    (-265 ppi density)
                            ...
                            <div class="connect_buttons">
                                ...
                                <button class="product_card_veiw_shop_button">
                                    <a href="">view shop <img src="{{asset('innocent/assets/image/badge.png')}}"
                                            alt=""></a>
                                </button>
                                <button class="product_card_connect_button">
                                    <a href="shop.html">connect <img
                                            src="{{asset('innocent/assets/image/Shopping bag.png')}}" alt=""></a>
                                </button>
                            </div> --}}
                        </div>
                ...
                <div class="main2">
                    ...
                    <div class="promotion">
                        ...
                        <p>
                            ...
                            Get an active badge by becoming a verified seller <br> and enjoy multiple benefits that
                            comes with being a verified seller
                            <br><br><br>
                            <a class="js-become-link js-get-started" href="/become"><button
                    ...
                    <div class="product_card_container">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col">
                                    <div
                                        class="product_card_display card-margin content-margin mt-4 js-mobileCard-down">


                                        {{-- <a href="product_des.html" class="product_card_link">
                                            <div class="card product_card">
                                                <h6 class="sold"> Sold 35 <br> <img
                                                        src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 4.0
                                                </h6>
                                                <img src="{{asset('innocent/assets/image/pexels-pixabay-164558.jpg')}}"
                                        ...
                                        {{-- <a href="product_des.html" class="product_card_link">
                                            <div class="card product_card">
                                                ...
                                                <div class="product_card_title">
                                                    ...
                                                    <p class="product_name">Mercedes-Benz M Class ML 350 4Matic 2012
                                                        Silver</p>
                                                    <span class="product_card_location"><i
                                                            class="fa-solid fa-location-dot"></i> Abuja</span>
                                        ...
                                        <a href="product_des.html" class="product_card_link">
                                            <div class="card product_card">
                                                <h6 class="sold"> Sold 175 <br> <img
                                                        src="innocent/assets/image/Rate.png" alt=""> 3.6</h6>
                    ...
                    <div class="tell_us_what_u_want_input_area">
                        ...
                        <input type="text" name="" class="tell_us_input js-input-mobile"
                            placeholder="write the details of what you are searching for the details here">
                        <button class="send js-send-mobile input-btn">
            ...
            <div class="main" id="main">
                            ...
                            <div class="col">
                                <div class="product_card_display card-margin content-margin mt-4 js-desktop-card">
                                    ...
                                    {{-- <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 35 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 4.0</h6>
                                            <img src="{{asset('innocent/assets/image/pexels-pixabay-164558.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                                    ...
                                    <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 7 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 3.6</h6>
                                            <img src="{{asset('innocent/assets/image/felipe-simo-dWQDNyPfKPU-unsplash.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                                    ...
                                    <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 175 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 3.6</h6>
                                            <img src="{{asset('innocent/assets/image/laptop.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                                    ...
                                    <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 75 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 5.0</h6>
                                            <img src="{{asset('innocent/assets/image/portrait-smiling-afro-american-male-photographer.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                                    ...
                                    <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 95 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 3.6</h6>
                                            <img src="{{asset('innocent/assets/image/laptop2.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                                    ...
                                    <a href="product_des.html" class="product_card_link">
                                        <div class="card product_card">
                                            <h6 class="sold"> Sold 70 <br> <img
                                                    src="{{asset('innocent/assets/image/Rate.png')}}" alt=""> 3.0</h6>
                                            <img src="{{asset('innocent/assets/image/usb-flash-drive-mockup-technology-data-storage-device.jpg')}}"
                                                class="card-img-top w-100 product_image" alt="...">
                ...
                <div class="promotion promotion2">
                    ...
                    <p>
                        ...
                        <br><br><br>
                        <a class="js-become-link  js-get-started2" href="/become"><button
                                class="get_started animate animate-pulse4">Get
                                Started</button></a>
                        {{-- <strong>Reach more audience by promoting your Product(s)</strong><br>
                        determine your target audience location, interest, select a <br>
                        convenient budget and duration
                        <br><br><br>
                        <button class="get_started animate animate-pulse4" onclick="showCard_get_started2()">Get
                            Started</button> --}}
                    </p>
                </div>
                ...
                <div class="tell_us_what_u_want_input_area tell_us_what_u_want_input_area2">
                    ...
                    <div class="vertical_bar"></div>
                    <input type="text" name="details" class="tell_us_input tell_us_input2  js-input2"
                        placeholder="write the details of what you are searching for the details here">
                    <button class="send js-send-input input-btn2">
        ...
        <div class="notification_main" id="notification_main" onclick="show_notification2()">
            ...
            <div class="notifications_region">
                ...
                <a href="{{ url('/rating') }}">
                    <div class="notification">
                        <div class="notification_details">
                            <div class="notification_image"><img src="{{asset('innocent/assets/image/logo icon.svg')}}"
                                    alt="Profile Picture">
                            </div>
                            <div class="message_area">
                                <p class="message"><strong>congratulations </strong> <br>it is a perfect time to tell
                                    the
                                    world about it.</p>
                                <p class="time">2 hours ago</p>

                            </div>
                            <img src="{{asset('innocent/assets/image/laptop2.jpg')}}" alt="Picture"
                ...
                <a href="#">
                    <div class="notification">
                        <div class="notification_details">
                            <img src="{{asset('innocent/assets/image/dp.png')}}" alt="Profile Picture"
                                class="notification_image">
                            <div class="message_area">
                                <p class="message"><strong>suggested for you </strong> <br>enjoy 1000 points to boost
                                    your
                                    product to reach more audience.</p>
                                <p class="time">5 hours ago</p>

                            </div>
                            <img src="{{asset('innocent/assets/image/laptop.jpg')}}" alt="Picture"
                                class="notification_product_image">
                ...
                <a href="#">
                    <div class="notification">
                        <div class="notification_details">
                            <img src="{{asset('innocent/assets/image/bike.png')}}" alt="Profile Picture"
                                class="notification_image">
                            <div class="message_area">
                                <p class="message"><strong>jane connected with you </strong> <br>tell us tell us your
                                    experience with the producttell us your experience with the product.your experience
                                    with
                                    the product.</p>
                    ...
                    <div class="notification">
                        <div class="notification_details">
                            <img src="{{asset('innocent/assets/image/bike.png')}}" alt="Profile Picture"
                                class="notification_image">
                            <div class="message_area">
                                <p class="message"><strong>congratulations </strong> <br>tell us your experience with
                                    the
                                    product.</p>
                    ...
                    <div class="notification">
                        <div class="notification_details">
                            <img src="{{asset('innocent/assets/image/bike.png')}}" alt="Profile Picture"
                                class="notification_image">
                            <div class="message_area">
                                <p class="message"><strong>congratulations </strong> <br>tell tell us your experience
                                    with
                    ...
                    <div class="notification">
                        <div class="notification_details">
                            <img src="{{asset('innocent/assets/image/dp.png')}}" alt="Profile Picture"
                                class="notification_image">
                            <div class="message_area">
                                <p class="message"><strong>congrats on your new listing </strong> <br>it is a perfect
                                    time
                                    to tell the world about it.</p>
                                <p class="time">2 hours ago</p>

                            </div>
                            <img src="{{asset('innocent/assets/image/Picture of product (USB).png')}}" alt="Picture"
                                class="notification_product_image">
    ...
    <div class="footer_contanier">
        ...
        <div class="footer_icons">
            <a href="https://web.facebook.com/loopmart/"><img src="{{asset('innocent/assets/image/facebook.png') }}"
                    alt=""></a>
